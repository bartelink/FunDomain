...
let [<Fact>]  ``After a full round it should be player 0 turn``() =
    test <@ [   GameStarted { GameId = gameId; PlayerCount = 4; FirstCard = red 3; FirstPlayer = 0 }
            ...
            |> run <| PlayCard { GameId = gameId; Player = 3; Card = red 1 }
